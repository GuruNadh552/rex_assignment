  ...
  void initState() {
    ...
    if (widget.claim != null) {
      employeeController.text =
          widget.claim!.employeeName;

      purposeController.text =
          widget.claim!.purpose;

      expenseDate =
          widget.claim!.expenseDate;
...
class ExpenseItemSheet
  ...
  @override
  State<ExpenseItemSheet>
      createState() =>
          _ExpenseItemSheetState();
}

class _ExpenseItemSheetState
    extends State<
        ExpenseItemSheet> {
